...
if __name__ == '__main__':
    ...
    conv_net = ConvODENet(device, img_size=(1, 352, 2), num_filters=32, output_dim=14, augment_dim=10)
    ...
    trainer = Trainer(conv_net, optimizer, device, classification=True, save_dir=('demos/ode_models', '/light_curve1'))
